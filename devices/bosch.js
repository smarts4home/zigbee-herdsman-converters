...
// light
            ...
            //exposes.enum('light', ea.ALL, ['ON', 'OFF', 'TOGGLE']).withDescription('On/Off Light 2').withEndpoint('left'),
            //exposes.enum('light', ea.ALL, ['ON', 'OFF', 'TOGGLE']).withDescription('On/Off Light 1').withEndpoint('right'),
